...
OK.addEventListener('click',()=>{
  ...
  for(i = 1; i <= entry; i++){
    runner.insertAdjacentHTML('beforeend',  `<div id = line><img id="image" src="C:/Users/nakay/Pictures/keiba_jockey1_white.png" width="100" height="100" alt="site-logo">${i}レーン</div>`)
  }
